...
class Atom(Topology):
    ...
    def __repr__(self):
        return (
            f"{self.__class__.__name__}({self.label}, eps={self.eps}, sig={self.sig})"
        )
...
class Improper(Topology):  # cvff improper style
    ...
    def __eq__(self, other):
        return (
            ...
            and self._a1.split("_")[0] == other._a1.split("_")[0]
        )
