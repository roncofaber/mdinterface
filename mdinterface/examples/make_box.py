...
from mdinterface.core.topology import Angle, Bond
from mdinterface.database import Metal111, Water
...
simobj = SimulationBox(
    solvent=mol, solute=[Na, Cl], interface=interface, enderface=interface
)
