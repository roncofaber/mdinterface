...
from mdinterface.database import Hydronium, Water
...
monomer, atoms, bonds, angles, dihedrals, impropers = read_lammps_data_file(
    "data/nafion_n1_dep.data.lammps"
)
